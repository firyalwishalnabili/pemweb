...
<body style="background-color: lightgreen;">
  <h3 align="center">DELETE DATA TRANS UPN</h3>
  <form action="" method="post">
    <table align="center" bgcolor="lime"  width="35%">
    <tr>
      <td>Masukkan ID yang akan dihapus : </td><br>
      <td><input type="number" name="id_trans_upn" size="12"></td>
    </tr>
    <tr>
      <br><br>
  ...
  include "koneksi.php";
  if (isset($_POST['save'])){
    $simpan = mysqli_query($koneksi, "DELETE driver WHERE id_trans_upn = '$_POST[id_trans_upn]';");
    if ($simpan){
